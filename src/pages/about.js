        ...
        <div className="container mx-auto max-w-container p-4 md:py-10 md:p-5">
          <div className="flex flex-col justify-around md:flex-row">
            <div className="flex flex-col justify-start mt-5 order-2 flex-1 md:mr-5 md:mt-0 md:order-1">
              <p className="text-2xl text-justify text-main-text">
          ...
          <div className="flex flex-col justify-around py-5 md:flex-row">
            <div className="flex flex-col justify-start flex-1 md:mr-5">
              ...
              <h2 className="pb-4 text-main-text">
                University of Brighton, United Kingdom
                <br />
                School of Computing, Engineering and Mathematics
              </h2>
              <p className="text-secondary-text text-xl text-justify">
            ...
            <div className="flex flex-col mt-5 flex-initial md:ml-5 md:mt-0">
              ...
              <ul className="pt-3 flex flex-col justify-between flex-wrap md:block">
                ...
                <li className="text-secondary-text text-xl mb-0">Redux</li>
                <li className="text-secondary-text text-xl mb-0">Typescript</li>
                <li className="text-secondary-text text-xl mb-0">Gatsby</li>
                <li className="text-secondary-text text-xl mb-0">Next</li>
                <li className="text-secondary-text text-xl mb-0">GraphQL</li>
                <li className="text-secondary-text text-xl mb-0">CircleCI</li>
                <li className="text-secondary-text text-xl mb-0">Node</li>
                <li className="text-secondary-text text-xl mb-0">Jest</li>
                <li className="text-secondary-text text-xl mb-0">Wordpress</li>
                <li className="text-secondary-text text-xl mb-0">Storybook</li>
              </ul>
            </div>
          </div>
        </div>
